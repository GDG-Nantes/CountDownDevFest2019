  ...
  backgroundSetup() {
    ...
    let backgroundMaterials = [
      ...
      new THREE.MeshPhongMaterial({
        ...
        // map: new THREE.TextureLoader().load('photos/aditya-chinchure-ZhQCZjr9fHo-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/boga-rin-aDu5aedOoD8-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/danny-howe-74kShnX5zZI-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/danny-howe-bn-D2bCvpik-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/jessey-bijl-5Rt5KhbUp5g-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/joel-amissa-wtZCSfqhWAs-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/joel-amissa-ycvsYWm2Wko-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/nainoa-shizuru-NcdG9mK3PBY-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/neonbrand-rJPwQr27vIM-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/sebastian-ervi-Qq2h76kYRFI-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/vishnu-r-nair-m1WZS5ye404-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/yannis-papanastasopoulos-yWF2LLan-_o-unsplash.jpg'),
        // map: new THREE.TextureLoader().load('photos/yvette-de-wit-NYrVisodQ2M-unsplash.jpg'),
